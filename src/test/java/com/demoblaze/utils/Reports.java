...
public class Reports {
	...
	public void startReport()
	{
		try
		{
			sparkReports= new ExtentSparkReporter(System.getProperty("user.dir")+"/WebPageAutomationReport.html");
			sparkReports.config().setReportName("Demoblaze Web Automation Report");
